...
# 6번 분량
departure = ["HKG", "TPE", "MNL", "HAN", "SIN", "CEB", "CRK", "BKI", "MFM", "CXR", "KUL", "HKT", "PVG",
             "CAN", "PEK", "TAO", "YNJ", "HGH", "SHA", "SHE", "DLC", "KIX", "NRT", "HND", "FUK", "OKA", "CTS", "NGO"]
destination = ["ICN"]
...
for n in range(total_len):
    # 파일 열기
    f = open(f'6_' + str(n), 'a', encoding='utf-8', newline='')  # 파일오픈
