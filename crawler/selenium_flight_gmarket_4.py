...
# 4번 분량
departure = ["SPN", "AKL", "BNE", "MEL", "CHC", "CNS", "ZQN", "PER", "ROR", "LAX", "HNL", "JFK", "YVR", "SFO", "YYZ", "LAS", "ATL", "DFW", "ORD", "SEA",
             "IAD", "CDG", "LHR", "BCN", "FRA", "FCO", "PRG", "IST", "MUC", "MAD", "VVO", "SVO", "VIE", "VCE", "ZRH", "AMS", "MXP", "WAW", "ZAG", "BKK", "DAD", "SGN"]
destination = ["ICN"]
...
for n in range(total_len):
    # 파일 열기
    f = open(f'4_' + str(n), 'a', encoding='utf-8', newline='')  # 파일오픈
    csvWriter = csv.writer(f)  # 열어둔 파일

    sub_idx = n * 7
    for sub in range(7):
        dep = departure[sub_idx + sub]
