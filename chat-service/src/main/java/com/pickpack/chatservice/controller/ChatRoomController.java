...
public class ChatRoomController {
    ...
    @PostMapping("/room")
    public ResponseEntity<RedisChatRoom> createRoom(@RequestBody CreateRoomReqDto createRoomReqDto) {
        return new ResponseEntity<>(chatRoomService.createChatRoom(createRoomReqDto), HttpStatus.CREATED);
    }
